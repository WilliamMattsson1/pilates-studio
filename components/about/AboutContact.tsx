...
const AboutContact = () => {
    return (
        <section className="px-6 md:px-20 pt-12 pb-8 bg-white flex flex-col gap-4">
            <TitleHeader
                title="Get in Touch"
                subtitle="Reach out to discuss classes or personal sessions"
                alignment="left"
            />

            <div className="flex flex-col lg:flex-row gap-6">
                <div className="flex-1 flex flex-col gap-4 bg-secondary-bg p-5 rounded-lg shadow-lg">
